...
const Banner = () => {
	return (
		<>
			...
			>
				<div className="absolute inset-0 bg-[rgba(0,0,0,0.4)] z-[1] "></div>
				<div className="flex items-center">
					<div className=" md:w-2/4 mx-auto text-center text-white z-40 relative py-28">
						<h2 className="font-poppins mb-10 font-extrabold text-center mt-36 text-6xl md:text-5xl text-[#4c4cf1] ">
							Welcome to ToyQuest
